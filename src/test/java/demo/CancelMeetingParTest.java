...
import com.amazonaws.lambda.demo.ParticipantCancelMeetingHandler;
import com.amazonaws.lambda.demo.ParticipantCancelMeetingRequest;
import com.amazonaws.lambda.demo.ParticipantCancelMeetingResponse;
...
public class CancelMeetingParTest {
	...
	public void testCancelMeetingOrg() throws IOException {
		...
		ParticipantCancelMeetingHandler handlerCancel = new ParticipantCancelMeetingHandler();

		String meetingCode = respCre.getSecretCode();
		ts = respShow1.getSchedule().getDays().get(0).getTimeslots().get(0); //first day 10:00

		String meetingId = ts.getMeeting().getId();

		ParticipantCancelMeetingRequest ar1 = new ParticipantCancelMeetingRequest(meetingId, meetingCode);
		...
		post = new Gson().fromJson(output.toString(), PostResponse.class);
		ParticipantCancelMeetingResponse resp1 = new Gson().fromJson(post.body, ParticipantCancelMeetingResponse.class);
